          ...
          signup ? (
            <div className="signup">
              ...
              <form onSubmit={signupHandler}>
                ...
                <div className='login-footer' ><button type="submit">Signup</button></div>
              </form>
              <div className='signup-header below_msg'> Returning user? click me login in <span onClick={() => setSignup(false)} style={{ "cursor": "alias" }}> &#128527;</span></div>
            </div>) : (
            <div className="login">
              ...
              <form onSubmit={loginHandler}>
                ...
                <div className='login-footer' ><button type="submit">Login</button></div>
              </form>
